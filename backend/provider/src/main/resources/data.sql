...
(43, '再见哥斯拉',   'Goodbye Godzilla',      'https://picsum.photos/seed/movie43/180/250', 0, '渡边谦,长谷川浩二',   '科幻,灾难',   '日本',     138, '2026年5月28日上映', '哥斯拉消失三十年后再次出现，这一次它要面对的不是人类的武器，而是另一个远古巨兽。', 58900, '', '[]', 0, NULL, '5月28日 周四', 0, 0, 18),
...
(4,  1, 2, '1号厅',      CURRENT_DATE, '10:30', '12:38', '国语',  120, 100, 42.00, 1),
(5,  1, 2, '2号厅',      CURRENT_DATE, '14:00', '16:08', '国语',  100,  75, 38.00, 1),
(6,  2, 1, 'IMAX厅',    CURRENT_DATE, '19:00', '21:16', '国语',  200, 150, 69.90, 1),
(7,  2, 3, 'IMAX厅',    CURRENT_DATE, '10:00', '12:16', '国语',  180, 160, 55.00, 1),
(8,  2, 3, '4DX厅',     CURRENT_DATE, '14:30', '16:46', '国语',  80,   60, 79.90, 1),
(9,  3, 4, 'IMAX厅',    CURRENT_DATE, '11:00', '12:58', '国语',  220, 190, 65.00, 1),
(10, 3, 4, '杜比影院',   CURRENT_DATE, '15:00', '16:58', '国语',  100,  80, 89.90, 1),
(11, 4, 5, 'IMAX厅',    CURRENT_DATE, '10:00', '12:22', '国语',  200, 170, 55.00, 1),
(12, 4, 5, '中国巨幕厅',  CURRENT_DATE, '14:00', '16:22', '国语',  160, 130, 49.00, 1),
(13, 5, 1, '3号厅',      CURRENT_DATE, '20:00', '21:55', '国语',  100,  90, 35.90, 1),
(14, 5, 9, 'IMAX厅',    CURRENT_DATE, '10:00', '11:55', '国语',  250, 220, 55.00, 1),
(15, 5, 9, '杜比全景声厅', CURRENT_DATE, '15:00', '16:55', '国语',  150, 120, 45.00, 1),
-- 低库存场次（用于测试超卖边界）
(16, 1, 1, '5号厅',      CURRENT_DATE, '22:00', '00:08', '国语',  80,   3,  29.90, 1),
(17, 2, 2, '3号厅',      CURRENT_DATE, '22:30', '00:46', '国语',  60,   1,  32.00, 1),
(18, 3, 3, '2号厅',      CURRENT_DATE, '21:00', '22:58', '国语',  90,   5,  35.00, 1),
-- 更多影院的场次数据（覆盖更多电影+影院组合）
(19, 1, 3, 'IMAX厅',    CURRENT_DATE, '09:30', '11:38', '国语',  180, 160, 55.00, 1),
(20, 1, 4, 'IMAX厅',    CURRENT_DATE, '11:00', '13:08', '国语',  220, 200, 65.00, 1),
(21, 1, 5, 'IMAX厅',    CURRENT_DATE, '13:00', '15:08', '国语',  200, 175, 55.00, 1),
(22, 2, 2, '1号厅',      CURRENT_DATE, '10:00', '12:16', '国语',  120, 100, 42.00, 1),
(23, 2, 4, 'IMAX厅',    CURRENT_DATE, '14:00', '16:16', '国语',  220, 180, 65.00, 1),
(24, 2, 5, '中国巨幕厅',  CURRENT_DATE, '16:30', '18:46', '国语',  160, 140, 49.00, 1),
(25, 3, 1, '杜比全景声厅', CURRENT_DATE, '10:00', '11:58', '国语',  150, 130, 49.90, 1),
(26, 3, 2, '2号厅',      CURRENT_DATE, '13:00', '14:58', '国语',  100,  85, 38.00, 1),
(27, 3, 5, 'IMAX厅',    CURRENT_DATE, '15:30', '17:28', '国语',  200, 170, 55.00, 1),
(28, 4, 1, 'IMAX厅',    CURRENT_DATE, '09:00', '11:22', '国语',  200, 185, 59.90, 1),
(29, 4, 2, '1号厅',      CURRENT_DATE, '12:00', '14:22', '国语',  120,  95, 42.00, 1),
(30, 4, 3, 'IMAX厅',    CURRENT_DATE, '15:00', '17:22', '国语',  180, 155, 55.00, 1),
(31, 5, 2, '2号厅',      CURRENT_DATE, '11:00', '12:55', '国语',  100,  80, 38.00, 1),
(32, 5, 3, '4DX厅',     CURRENT_DATE, '14:00', '15:55', '国语',   80,  65, 79.90, 1),
(33, 5, 4, 'IMAX厅',    CURRENT_DATE, '17:00', '18:55', '国语',  220, 195, 65.00, 1),
(34, 5, 5, 'IMAX厅',    CURRENT_DATE, '19:30', '21:25', '国语',  200, 170, 55.00, 1),
-- 明天的场次
(35, 1, 1, 'IMAX厅',    CURRENT_DATE + 1, '10:00', '12:08', '国语', 200, 200, 59.90, 1),
(36, 1, 1, '杜比全景声厅', CURRENT_DATE + 1, '14:00', '16:08', '国语', 150, 150, 49.90, 1),
(37, 1, 2, '1号厅',      CURRENT_DATE + 1, '10:30', '12:38', '国语', 120, 120, 42.00, 1),
(38, 2, 1, 'IMAX厅',    CURRENT_DATE + 1, '19:00', '21:16', '国语', 200, 200, 69.90, 1),
(39, 2, 3, 'IMAX厅',    CURRENT_DATE + 1, '10:00', '12:16', '国语', 180, 180, 55.00, 1),
(40, 3, 4, 'IMAX厅',    CURRENT_DATE + 1, '11:00', '12:58', '国语', 220, 220, 65.00, 1);
